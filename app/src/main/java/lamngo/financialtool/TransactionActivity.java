...
/**
 * Displays Transactions table with all transactions
 */

public class TransactionActivity extends AppCompatActivity {

    /** Tag for the log messages */
    public static final String LOG_TAG = TransactionActivity.class.getSimpleName();
    ...
    private class TransactionAsyncTask extends AsyncTask<URL, Void, ArrayList> {
         ...
         * {@link TransactionActivity.TransactionAsyncTask}).
         */
        @Override
